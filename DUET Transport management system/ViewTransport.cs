...
namespace DUET_Transport_management_system
{
    public partial class ViewTransport : Form
    {
        ...
        private void ViewTransportGrid_Load(object sender, EventArgs e)
        {
            SqlConnection cnn;

            cnn = new SqlConnection("Server=.\\SQLEXPRESS;Database=DTMS; Integrated Security=true");
            SqlCommand cmd = new SqlCommand("select * from transport;", cnn);
            //cnn.Open();
            try
            {
                ...
                ViewTransportGrid1.DataSource = bsource;
                sda.Update(dt);
            }
            catch (Exception ex)
            {
        ...
        private void ViewTransportGrid1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void usageEquipmentToolStripMenuItem1_Click_1(object sender, EventArgs e)
        {
        ...
        private void equipmentInfoToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        private void storedEquipmentToolStripMenuItem2_Click_1(object sender, EventArgs e)
        {
