    ...
    public partial class EditTeacherForm : Form
    {
       // int i = 0;
        ...
        private void TeacherIdComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cnn = new SqlConnection("Server=.\\SQLEXPRESS;Database=DTMS; Integrated Security=true");
            SqlCommand cmd = new SqlCommand("select teacher_name,teacher_designation,teacher_dept,contact_number from teacher where teacher_id='" + this.TeacherIdComboBox.Text + "';", cnn);
            cnn.Open();
            ...
            TeacherDesignationComboBox.Text = result1;
            TeacherDeptComboBox.Text = result2;
        ...
        private void SubmitButton_Click(object sender, EventArgs e)
        {
            ...
            string query = "update teacher set teacher_id='" +TeacherIdComboBox.Text + "',teacher_name='"+TeacherNameTextBox.Text+"',teacher_dept='"+TeacherDeptComboBox.Text+"',teacher_designation='"+TeacherDesignationComboBox.Text+"',contact_number='"+ContactTextBox.Text+"' where teacher_id='"+this.TeacherIdComboBox.Text+"';";
            cnn.Open();
        ...
        private void deletebutton_Click(object sender, EventArgs e)
        {
            ...
            string query = "delete from  teacher  where teacher_id ='" + this.TeacherIdComboBox.Text + "';";
            cnn.Open();
            SqlCommand cmd = new SqlCommand(query, cnn);
            SqlDataReader reader = cmd.ExecuteReader();
            reader.Close();
